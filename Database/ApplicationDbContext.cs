    ...
    public class ApplicationDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
                    ...
                    new Video
                    {
                     ...
                     new Video
                     {
                      ...
                      new Video
                      {
                          ...
                          ReleaseDate = new DateTime(2015, 5, 29),
                          Type = VideoType.Movie,
            ...
            modelBuilder.Entity<Rating>().HasData(
                new Rating { Id = 1, Score = 6, VideoId = 1 },
                new Rating { Id = 2, Score = 5, VideoId = 1 },
                new Rating { Id = 3, Score = 4, VideoId = 2 },
                new Rating { Id = 4, Score = 7, VideoId = 2 },
                new Rating { Id = 5, Score = 4, VideoId = 3 },
                new Rating { Id = 6, Score = 5, VideoId = 3 },
                new Rating { Id = 7, Score = 7, VideoId = 4 },
                new Rating { Id = 8, Score = 5, VideoId = 4 },
                new Rating { Id = 9, Score = 7, VideoId = 5 },
                new Rating { Id = 10, Score = 4, VideoId = 5 },
                new Rating { Id = 11, Score = 8, VideoId = 6 },
                new Rating { Id = 12, Score = 5, VideoId = 6 },
                new Rating { Id = 13, Score = 9, VideoId = 7 },
                new Rating { Id = 14, Score = 5, VideoId = 7 },
                new Rating { Id = 15, Score = 8, VideoId = 8 },
                new Rating { Id = 16, Score = 5, VideoId = 8 },
                new Rating { Id = 17, Score = 6, VideoId = 9 },
                new Rating { Id = 18, Score = 3, VideoId = 9 },
                new Rating { Id = 19, Score = 4, VideoId = 10 },
                new Rating { Id = 20, Score = 3, VideoId = 10 },
                new Rating { Id = 21, Score = 4, VideoId = 11 },
                new Rating { Id = 22, Score = 10, VideoId = 11 },
                new Rating { Id = 23, Score = 9, VideoId = 12 },
                new Rating { Id = 24, Score = 4, VideoId = 12 },
                new Rating { Id = 25, Score = 3, VideoId = 13 },
                new Rating { Id = 26, Score = 4, VideoId = 13 },
                new Rating { Id = 27, Score = 8, VideoId = 14 },
                new Rating { Id = 28, Score = 10, VideoId = 14 },
                new Rating { Id = 29, Score = 5, VideoId = 15 },
                new Rating { Id = 30, Score = 9, VideoId = 15 },

                ///TvShows Rating
                new Rating { Id = 31, Score = 4, VideoId = 16 },
                new Rating { Id = 32, Score = 6, VideoId = 16 },
                new Rating { Id = 33, Score = 5, VideoId = 17 },
                new Rating { Id = 34, Score = 7, VideoId = 17 },
                new Rating { Id = 35, Score = 8, VideoId = 18 },
                new Rating { Id = 36, Score = 8, VideoId = 18 },
                new Rating { Id = 37, Score = 7, VideoId = 19 },
                new Rating { Id = 38, Score = 5, VideoId = 19 },
                new Rating { Id = 39, Score = 7, VideoId = 20 },
                new Rating { Id = 40, Score = 8, VideoId = 20 },
                new Rating { Id = 41, Score = 8, VideoId = 21 },
                new Rating { Id = 42, Score = 6, VideoId = 21 },
                new Rating { Id = 43, Score = 9, VideoId = 22 },
                new Rating { Id = 44, Score = 6, VideoId = 22 },
                new Rating { Id = 45, Score = 8, VideoId = 23 },
                new Rating { Id = 46, Score = 7, VideoId = 23 },
                new Rating { Id = 47, Score = 10, VideoId = 24 },
                new Rating { Id = 48, Score = 9, VideoId = 24 },
                new Rating { Id = 49, Score = 10, VideoId = 25 },
                new Rating { Id = 50, Score = 10, VideoId = 25 },
                new Rating { Id = 51, Score = 6, VideoId = 26 },
                new Rating { Id = 52, Score = 8, VideoId = 26 },
                new Rating { Id = 53, Score = 3, VideoId = 27 },
                new Rating { Id = 54, Score = 4, VideoId = 27 },
                new Rating { Id = 55, Score = 7, VideoId = 28 },
                new Rating { Id = 56, Score = 8, VideoId = 28 },
                new Rating { Id = 57, Score = 9, VideoId = 29 },
                new Rating { Id = 58, Score = 8, VideoId = 29 },
                new Rating { Id = 59, Score = 5, VideoId = 30 },
                new Rating { Id = 60, Score = 6, VideoId = 30 }
